$(document).ready(function() {
    ...
    /*$('.delete-form').click(function(){
        ...
        $(".frmIgn").submit(function(){

        var thisSelector = "#formIgnorar"+$("#petNick").val();
        var confSelector = "#formConfirmacion"+$("#petNick").val();


        var url=$(thisSelector).attr("action");
        console.log($("#petNick").val());
        console.log(thisSelector);
        console.log(confSelector);
        $.post(url,{
            nombre:$("#petNick").val(),
            other:"attributes"
        },function(data){
